...
This is the main API server for the Beautyn Marketplace platform. It handles business logic, authentication, booking requests, and communication with the CRM integrations services.
